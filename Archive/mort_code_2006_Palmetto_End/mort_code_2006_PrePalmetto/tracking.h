...
//#define PAN_SERVO pwm10  now defined in MORT_DEFINES.h

// By default, PWM output two is used for the tilt servo.
// Change it to another value if you'd like to use PWM
// output two for another purpose.
//#define TILT_SERVO pwm11	now defined in MORT_DEFINES.h
...
// pan servo travel
#define PAN_MIN_PWM_DEFAULT 0   	//  Right
#define PAN_MAX_PWM_DEFAULT 254		//  Left
...
#define PAN_SEARCH_STEP_SIZE_DEFAULT 128
...
#define TILT_CENTER_PWM_DEFAULT 127

// These values define the lower and upper bound on the
// tilt servo travel
#define TILT_MIN_PWM_DEFAULT 127	
#define TILT_MAX_PWM_DEFAULT 200
...
#define TILT_SEARCH_STEP_SIZE_DEFAULT 70
